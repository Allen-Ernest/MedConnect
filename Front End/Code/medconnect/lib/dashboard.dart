...
class _HomeState extends State<Home> with Logic {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: _selectedIndex == 3 ? const TabBar(tabs: [
        ...
        body: _selectedIndex == 3 ? const TabBarView(
          children: <Widget>[
            Tab(child: Text('Messaged chats will appear here')),
            Tab(child: Chats())
          ]
